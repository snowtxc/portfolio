...
<template>
    <div class="py-2 px-2 flex flex-col gap-5 bg-white rounded-lg"> 
        <div class="rounded-lg hover:bg-primary p-2 px-4 hover:bg-opacity-25 hover:cursor-pointer transition duration-500" @click="openTab(linkedinUrl)">
